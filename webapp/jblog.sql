...
SET DEFINE OFF;
Insert into JBLOG.BLOG (ID,BLOGTITLE,LOGOFILE) values ('eee','e5의 블로그입니다.','spring-logo.jpg');
Insert into JBLOG.BLOG (ID,BLOGTITLE,LOGOFILE) values ('qqq','q1블로그 제목 수정O,  로고 수정O 완료1','1613909278339e391a895-19cb-441e-a744-010db3444cfd.png');
Insert into JBLOG.BLOG (ID,BLOGTITLE,LOGOFILE) values ('www','w2의 블로그입니다.','spring-logo.jpg');
...
SET DEFINE OFF;
Insert into JBLOG.USERS (USERNO,ID,USERNAME,PASSWORD,JOINDATE) values (17,'www','w2','222',to_date('21/02/19','RR/MM/DD'));
Insert into JBLOG.USERS (USERNO,ID,USERNAME,PASSWORD,JOINDATE) values (15,'eee','e5','555',to_date('21/02/19','RR/MM/DD'));
Insert into JBLOG.USERS (USERNO,ID,USERNAME,PASSWORD,JOINDATE) values (16,'qqq','q1','111',to_date('21/02/19','RR/MM/DD'));
--------------------------------------------------------
